...
class SpecialistProfileSerializer(serializers.ModelSerializer):
    ...
    full_name = serializers.CharField(source='user.full_name', required=False, allow_blank=False, allow_null=False)
    bio = serializers.CharField(source='user.bio', required=False, allow_blank=True, allow_null=True)
    contact_phone = serializers.CharField(source='user.contact_phone', required=False, allow_blank=False, allow_null=False)
    contact_email = serializers.EmailField(source='user.contact_email', required=False, allow_blank=False, allow_null=False)
